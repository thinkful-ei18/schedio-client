      ...
      <StyleRoot>
        <div className="info-progression" style={styles.zoomInRight}>
          ...
          <div className="instructions">
            ...
            <img src={UserRegistration} alt='user registration'/>
            ...
            <img src={EventTabs} alt='event tabs'/>            
            ...
            <ol>
              <img src={EventStep1} alt='event step 1'/>                        
              <li>
              ...
              <img src={EventStep2} alt='event step 2'/>                        
              <li>
              ...
              <img src={EventStep3} alt='event step 3'/>                                      
              <li>
              ...
              <img src={EventStep4} alt='event step 4'/>                                      
              <li>
            ...
            <img src={WidgetGear} alt='widget gear'/>                                      
            ...
            <img src={WidgetConfig} alt='widget config'/>                                                  
            ...
            <img src={MapWidget} alt='map widget'/>                                                                   
            <p>
            ...
            <img src={MapWidgetChange} alt='map widget change'/>                                                                   
            <p>
            ...
            <img src={MapWidgetConfirm} alt='map widget confirm'/>                                                                               
            <p>
              Click "Confirm" to save the new title and location on widget.
            </p>
            <h2>Hiking Widget Instructions</h2>                          
            <img src={HikingWidgetBefore} alt='hiking widget before'/>                                                                               
            <p>
            ...
            <img src={HikingWidgetAfter} alt='hiking widget after'/>                                                                                                     
            <p>
            ...
            <img src={FoodWidgetBefore} alt='food widget before'/>                                                                                                     
            <p>
            ...
            <img src={FoodWidgetAfter} alt='food widget after'/>                                                                                                     
            <p>
